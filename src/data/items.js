...
export const ITEMS = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "동시 3~4건이 겹치는 달에도 결품·배송 클레임 없이 운영",
  ...
  },
  {
    ...
    label: "광고 운영 · 측정 체계 설계",
    number: "소재 6종 A/B",
    period: "메타 · 네이버 광고 직접 기획·집행",
    bullets: [
      "CPC·도달·빈도 비교해 저효율 소재 예산을 고효율 소재로 재배분",
      "스마트스토어 연동 구조상 전환 데이터가 끊기는 한계 확인",
      "픽셀·UTM 도입안을 정리해 다음 캠페인의 측정 기준 마련",
    ],
